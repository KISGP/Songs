<template>
	<div ref="max" class="max">
		...
		<div class="main">
			...
			<lyric :focus-status="focusStatus" :show-translation="translationVisible" />
		</div>
	</div>
</template>
...
import songCard from "components/content/song-card/big.vue";

const SongStore = useSongStore();
const DataStore = useDataStore();

const props = defineProps<{
	translationV: boolean;
}>();
...
function changeTranslationVisible() {
